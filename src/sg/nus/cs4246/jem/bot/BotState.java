...
public class BotState {
	...
	protected void updateSetting(String key, String value) {
		...
		if( key.equals("yourBot") ) {
			myName = value;
		} else if ( key.equals("timeBank") ) {		// Maximum amount of time your sg.nus.cs4246.jem.bot can take for one response
		...
		} else if ( key.equals("startingStack") ) {	// Starting stack for each sg.nus.cs4246.jem.bot
	...
	protected void updateMatch(String key, String value) {
		...
		} else if( key.equals("onButton") ) {		// Which sg.nus.cs4246.jem.bot has the button, onButton is true if it's your sg.nus.cs4246.jem.bot
	 ...
	 * @param bot : sg.nus.cs4246.jem.bot that this move belongs to (either you or the opponent)
	 * @param key : key of the information given
